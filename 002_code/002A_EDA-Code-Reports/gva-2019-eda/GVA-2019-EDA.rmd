...
```{r}
library(readr)
gva_2019 <- read_csv("gva-2019.csv", 
...
makeDataReport(gva_2019, replace=TRUE)
...
create_report(gva_2019,
              output_format = html_document(toc = TRUE, 
                                            toc_depth = 6, 
                                            theme = "yeti"),
              output_file = "gva_2019_eda.html",
              report_title = "gva_2019_eda Data Report")
```
