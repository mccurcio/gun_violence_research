...
```{r}
library(readr)
gva_2017 <- read_csv("gva-2017.csv", 
...
makeDataReport(gva_2017, replace=TRUE)
...
create_report(gva_2017,
              output_format = html_document(toc = TRUE, 
                                            toc_depth = 6, 
                                            theme = "yeti"),
              output_file = "gva_2017_eda.html",
              report_title = "gva_2017_eda Data Report")
```
