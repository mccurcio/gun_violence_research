...
`r pagebreak()`
## Graphic of Cumulative Deaths vs Days for Given Year

**graph_deaths**

```{r message=FALSE, warning=FALSE}
graph_deaths <- function(gva_df, i){
  #print("graph_deaths")
  require(ggplot2)
  plot(ggplot(gva_df, aes(x=gva_df$Days, y=gva_df$Cum_Killed)) +
       geom_line() +
       ggtitle("Cumulative Killed Per Year", subtitle = i) +
       labs(x='Day No. of 365 Days', y="Cumulative Killed") +
...
## Cumulative Total Shot (Killed + Injured) vs Days For Given Year
